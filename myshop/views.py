...
from myshop.form import CustomUserForm
from . models import *
...
def favviewpage(request):
  if request.user.is_authenticated:
    ...
    return render(request,"myshop/fav.html",{"fav":fav})
  else:
    return redirect("/")
...
def cart_page(request):
  if request.user.is_authenticated:
    ...
    return render(request,"myshop/cart.html",{"cart":cart})
  else:
    return redirect("/")
...
def product_details(request,cname,pname):
    ...
    if(Catagory.objects.filter(name=cname,status=0)):
      if(Product.objects.filter(name=pname,status=0)):
        ...
        return render(request,"myshop/products/product_details.html",{"products":products})
      else:
